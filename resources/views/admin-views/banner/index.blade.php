                        ...
                        <div class="col-md-6">
                            <div class="d-flex flex-column justify-content-center h-100">
                                ...
                                <label class="upload--vertical">
                                    ...
                                    <img id="viewer" src="{{asset('assets/admin/img/upload-vertical.png')}}" alt="banner image"/>
                                </label>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table">
                    ...
                    @foreach($banners as $key=>$banner)
                        <tr>
                            ...
                            <td>
                                <div>
                                    <img class="img-vertical-150" src="{{asset('storage/banner')}}/{{$banner['image']}}" onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'">
                                </div>
                            </td>
                            <td>
