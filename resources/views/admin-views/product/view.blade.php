                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <a class="resturant&#45;&#45;information-single" href="{{route('admin.vendor.view', $product->store_id)}}">
                            <img class="img&#45;&#45;120 rounded mx-auto mb-3" onerror="this.src='{{asset('assets/admin/img/160x160/img1.jpg')}}'" src="{{asset('storage/store/'.$product->store->logo)}}" alt="Image Description">
