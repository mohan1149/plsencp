    ...
    <div class="auth-wrapper">
        ...
        <div class="auth-wrapper-left">
            <div class="auth-left-cont">
                <img onerror="this.src='{{asset('assets/admin/img/160x160/img2.jpg')}}'" src="{{asset('storage/restaurant')}}/{{\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value}}" alt="public/img">
