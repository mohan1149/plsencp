                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <?php if(Helpers::module_permission_check(MANAGEMENT_SECTION['pos_management'])): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/pos*')?'active':''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="<?php echo e(translate('POS')); ?>">
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/orders*')?'active':''); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/all')?'active':''); ?>">
                                        <a class="nav-link" href="<?php echo e(route('admin.orders.list',['all'])); ?>" title="<?php echo e(translate('all_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/pending')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['pending'])); ?>" title="<?php echo e(translate('pending_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/confirmed')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['confirmed'])); ?>" title="<?php echo e(translate('confirmed_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/processing')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['processing'])); ?>" title="<?php echo e(translate('processing_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate  sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/delivered')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['delivered'])); ?>" title="<?php echo e(translate('delivered_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate  sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/returned')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['returned'])); ?>" title="<?php echo e(translate('returned_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate  sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/failed')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['failed'])); ?>" title="<?php echo e(translate('failed_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate  sidebar--badge-container">
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/orders/list/canceled')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.orders.list',['canceled'])); ?>" title="<?php echo e(translate('canceled_orders')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate  sidebar--badge-container">
                        ...
                        <?php if(Helpers::module_permission_check(MANAGEMENT_SECTION['product_management'])): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/category*')?'active':''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:" title="<?php echo e(translate('category setup')); ?>"
                                >
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/product*') || Request::is('admin/attribute*')?'active':''); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/product/list*')?'active':''); ?> <?php echo e(Request::is('admin/product/add-new')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.product.list')); ?>" title="<?php echo e(translate('list')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/product/bulk-import')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.product.bulk-import')); ?>" title="<?php echo e(translate('bulk_import')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/product/bulk-export-index')?'active':''); ?>">
                                        <a class="nav-link " href="<?php echo e(route('admin.product.bulk-export-index')); ?>" title="<?php echo e(translate('bulk_export')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/product/limited-stock')?'active':''); ?>">
                                        <a class="nav-link" href="<?php echo e(route('admin.product.limited-stock')); ?>" title="<?php echo e(translate('Limited Stocks')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <?php if(Helpers::module_permission_check(MANAGEMENT_SECTION['report_management'])): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/report/sale-report')?'active':''); ?>">
                                <a class="nav-link " href="<?php echo e(route('admin.report.sale-report')); ?>" title="<?php echo e(translate('sale')); ?> <?php echo e(translate('report')); ?>">
                                    <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/report/order')?'active':''); ?>">
                                ...
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span
                                        class="text-truncate"><?php echo e(translate('Order Report')); ?></span>
                                </a>
                            </li>
                        ...
                        <?php if(Helpers::module_permission_check(MANAGEMENT_SECTION['user_management'])): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/customer/subscribed-email*')?'active':''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="<?php echo e(route('admin.customer.subscribed_emails')); ?>" title="<?php echo e(translate('Subscribed Emails')); ?>">
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/employee*')?'active':''); ?>  <?php echo e(Request::is('admin/custom-role*')?'active':''); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub <?php echo e(Request::is('admin/custom-role*')?'d-block':''); ?>"
                                    ...
                                    <li class="nav-item <?php echo e(Request::is('admin/custom-role*')?'active':''); ?>">
                                        <a class="nav-link"
                                        href="<?php echo e(route('admin.custom-role.create')); ?>" title="<?php echo e(translate('Employee Role Setup')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    ...
                                    <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/employee*')?'active':''); ?>">
                                        ...
                                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                            ...
                                            <li class="nav-item <?php echo e(Request::is('admin/employee/add-new')?'active':''); ?>">
                                                <a class="nav-link " href="<?php echo e(route('admin.employee.add-new')); ?>" title="<?php echo e(translate('add_new')); ?>">
                                                    <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        <?php if(Helpers::module_permission_check(MANAGEMENT_SECTION['system_management'])): ?>
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/store*')?'active':''); ?>">
                                <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('admin.business-settings.store.ecom-setup')); ?>"
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/web-app/payment-method*')
                                ...
                                <a class="nav-link" href="<?php echo e(route('admin.business-settings.web-app.payment-method')); ?>" title="<?php echo e(translate('Web & Apps Settings')); ?>" >
                            ...
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/page-setup/*')?'active':''); ?>">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item mt-0 <?php echo e(Request::is('admin/business-settings/page-setup/*')?'active':''); ?>">
                                        <a class="nav-link" href="<?php echo e(route('admin.business-settings.page-setup.about-us')); ?>" title="<?php echo e(translate('Page Setup')); ?>">
                                            <span class="tio-circle nav-indicator-icon"></span>
                            ...
                            <li class="nav-item mt-0
                                ...
                                <a class="nav-link" href="<?php echo e(route('admin.business-settings.web-app.system-setup.language.index')); ?>" title="<?php echo e(translate('system_settings')); ?>">
                                    <i class="tio-security-on-outlined nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('system_setup')); ?></span>
                                </a>
                            </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/909502.cloudwaysapps.com/dphjjcvmmc/public_html/resources/views/layouts/admin/partials/_sidebar.blade.php ENDPATH**/ ?>